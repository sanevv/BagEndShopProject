...
@WebServlet(
        ...
        urlPatterns = { "*.do" },
        initParams = {
                @WebInitParam(name = "propertyConfig", value = "C:/NCS/workspace_jsp/semi_project/semi-project-shop/src/main/java/com/github/semiprojectshop/config/servlet/Command.properties", description = "*.up 에 대한 클래스의 매핑파일")
        })
