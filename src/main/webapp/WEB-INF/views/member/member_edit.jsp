...
<script type="text/javascript" src="<%= ctxPath%>/js/member/memberEdit.js" defer></script>
	             ...
	             <tbody>
	                ...
	                <tr>
	                    ...
	                    <td>
	                       ...
	                       <input type="text" name="hp2" id="hp2" size="6" maxlength="4" value="${fn:substring(requestScope.phoneNumber, 4, 8)}" />&nbsp;-&nbsp;
	                       <input type="text" name="hp3" id="hp3" size="6" maxlength="4" value="${fn:substring(requestScope.phoneNumber, 9, 13)}" />
	                ...
	                <tr>
	                    <td>우편번호</td>
	                    <td>
	                       <input type="text" name="postcode" id="postcode" size="6" maxlength="5" value="${sessionScope.loginUser.zipCode}" />&nbsp;&nbsp;
	                       <%-- 우편번호 찾기 --%>
	                ...
	                <tr>
	                    ...
	                    <td>
	                       ...
	                       <input type="text" name="detailaddress" id="detailAddress" size="40" maxlength="200" placeholder="상세주소" value="${sessionScope.loginUser.addressDetail}" />&nbsp;
							<input type="text" name="extraaddress" id="extraAddress" size="40" maxlength="200" placeholder="참고항목" value="${sessionScope.loginUser.addressReference}" />
	                ...
	                <tr>
	                    <td colspan="2" class="text-center" style="padding: 30px 0 10px 0;">
	                       <input type="button" class="btn btn-success mr-5" value="수정하기" onclick="goEdit('${requestScope.user.userId}')" />
